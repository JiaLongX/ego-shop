       ...
       <div class="row">
			...
			<tr role="row" align="center" class="1" id="1_1" >
	                     ...
	                     <td align="left" style="padding-left:5em"> 
	                      <span class="glyphicon glyphicon-plus btn-warning" style="padding:2px; font-size:12px;"  id="icon_1_1" aria-hidden="false" onclick="rowClicked(this)" ></span>&nbsp;                             <span>${gcv01.name}</span>
			     		 </td>
			...
			<tr role="row" align="center" class="2" id="2_12" style="display:none">
	                     ...
	                     <td align="left" style="padding-left:10em"> 
	                      <span class="glyphicon glyphicon-plus btn-warning" style="padding:2px; font-size:12px;"  id="icon_2_12" aria-hidden="false" onclick="rowClicked(this)" ></span>&nbsp;                             <span>${gcv02.name}</span>
			     		 </td>
