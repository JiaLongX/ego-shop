			...
			<div class="dl_zc">
				...
				<div class="dl-con" id="regist">
					<form id="formpersonal" method="post" onsubmit="return false;">
						<input type="text" id="yzm" name="yzm" class="text" tabindex="4" value=""/>
						<div class="form">
...
<#--							</div>-->
					...
					<!--item end-->
					<button id="TencentCaptcha" data-appid="2041130276" data-cbfn="callbackName" data-biz-state="data-biz-state"
							type="button">验证</button>
					<div class="item">
						<span class="label">&nbsp;</span>
						<input type="button" class="btnimg" id="registsubmit" value=""
							   tabindex="8" onclick="submit()"/>
					</div>
					<!--item end-->
				</div><!--regist end-->
			</div><!--dl_zc end-->
...
<script type="text/javascript">
	function submit() {
		...
		console.log($("#formpersonal").serialize());
		$.ajax({
